...
class Test_Base_Model(unittest.TestCase):
    ...
    def value_dic(self):
        ...
        self.assertEqual(dict_object["created_at"], self.object.created_at.strftime(time_format))
        self.assertEqual(dict_object["updated_at"], self.object.created_at.strftime(time_format))
